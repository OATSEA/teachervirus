            ...
            <div id="container">
                ...
                <div id="main" style="display:none">
                    ...
                    ?>
                            <div>
                                <b>Chmod?</b>
                                <input type="checkbox" name="chmod" id="chmod" value="<?php echo isset($_POST['chmod']) ? $_POST['chmod'] : SHOW_CHMOD; ?>" <?php echo (SHOW_CHMOD == 1) ? "checked='checked'" : ""; ?> onclick="changeValue('chmod');">
                            </div>
                    <?php 
                        }
                        else
